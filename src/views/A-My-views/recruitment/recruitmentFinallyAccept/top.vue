...
const emit = defineEmits(['searchRecruitment', 'changeUserInfoByState','changeUserInfo'])
//获取所有部门
...
//状态
const selectStateValue = ref("Accepted")
//状态选项
const states = ref([
  { key: "Accepted", value: "已录取" },
  { key: "FinallyAccepted", value: "最终录取" }
])
getGepartments()
//查询干事申请表
...
<template>
  <div class="top_box" id="top_box">
    ...
    <div v-if="props.showSelectDepartmentView" class="select_by_department" id="select_by_department">
      <el-select v-model="selectedValue" @change="value=>{$emit('changeUserInfo',value)}" placeholder="请选择部门" clearable>
