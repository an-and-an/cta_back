        ...
        <template #file="{ file }">
          <div>
            ...
            <span class="el-upload-list__item-actions">
              <!-- 预览 -->
              <span
                class="el-upload-list__item-preview action_item"
              ...
              <!-- 上移 -->
              <span
                class="el-upload-list__item-delete action_item"
                @click="moveUp(file)"
              >
                <el-icon>
                  <Top />
...
const handleUpload = (res, uploadFiles) => {
  if (res.code === 0) {
    imgInfo.value.href = res.data[0].host + "/" + res.data[0].path;
    imgInfo.value.url = res.data[0].host + "/" + res.data[0].path;
