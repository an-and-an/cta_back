...
//当前管理员的新密码以及确认
let CurrentAdminPassward = ref()
let CurrentAdminPasswardAgain = ref()
//当前管理员的用户名
let CurrentAdminInEditUserName = ref()
...
const ComfirmToDeleteAdminAccount = () => {
    console.log(deleteAdminInfo.value.id);
    ...
    <el-dialog v-model="showEditAdminPassward" width="50%">
        ...
        <el-form label-width="100px" label-position="left">
            ...
            <el-form-item label="用户" required="true">
                <el-input v-model="CurrentAdminInEditUserName" />
            </el-form-item>
            <!-- 新密码 -->
            <el-form-item label="密码 " required="true">
                <el-input v-model="CurrentAdminPassward" type="password" placeholder="请输入新密码" show-password />
            </el-form-item>
            <!-- 新密码确认 -->
            <el-form-item label="确认密码 " required="true">
                <el-input v-model="CurrentAdminPasswardAgain" type="password" placeholder="请再次输入密码" />
            </el-form-item>
        </el-form>
    </el-dialog>
    <!-- 删除管理员dialog -->
